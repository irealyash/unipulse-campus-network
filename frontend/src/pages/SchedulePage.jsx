                    ...
                    >
                        ...
                        {file ? (
                            ...
                            <>
                                ...
                                <p className="text-sm text-base-content/60 mt-2">(Only add the current term's schedule, or the upcoming term's schedule if no other term is in progress. Manipulating or editing course sections will result in an instant permanent ban.
                                    You may delete the 'My Enrolled Courses' column completely for privacy,
                                    but modifying any other data is strictly prohibited.)</p>
                            </>
                        )}
                        <input
                            ref={inputRef}
