...
/** Chevron (▼) — rotate for sidebar toggle */
...
/** Pin — pass `pinned` to show a slash (already pinned). */
export const PinIcon = ({ pinned = false, className = '', ...p }) => (
  <svg {...base({ className, ...p })}>
    <path d="M12 17v5" />
    <path d="M9 3h6l1 7h4v2H4v-2h4z" />
    {pinned && <line x1="4" y1="4" x2="20" y2="20" strokeWidth={2.5} />}
  </svg>
);
